...
Free = unlimited single-file conversion. Premium is a StoreKit 2 auto-renewable
subscription with monthly (`com.lukemclaughlin.recast.premium.monthly`) and annual
(`com.lukemclaughlin.recast.premium.annual`) plans. It adds batch and folder conversion
plus automatic workflows. DEBUG has a local unlock toggle.
